    ...
    gml: OpenLayers.Util.applyDefaults(
      {
        _inherit: function (node, obj, container) {
          ...
          var dim =
            parseInt(node.getAttribute("srsDimension"), 10) ||
  ...
  setGeometryTypes: function () {
    this.geometryTypes = {
      ...
      "OpenLayers.Geometry.LineString":
        this.curve === true ? "Curve" : "LineString",
      "OpenLayers.Geometry.MultiLineString":
        this.multiCurve === false ? "MultiLineString" : "MultiCurve",
      "OpenLayers.Geometry.Polygon":
        this.surface === true ? "Surface" : "Polygon",
      "OpenLayers.Geometry.MultiPolygon":
        this.multiSurface === false ? "MultiPolygon" : "MultiSurface",
