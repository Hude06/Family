...
OpenLayers.Format.KML = OpenLayers.Class(OpenLayers.Format.XML, {
      ...
      switch (type.toLowerCase()) {
        ...
        case "iconstyle":
          ...
          var scale = parseFloat(
            this.parseProperty(styleTypeNode, "*", "scale") || 1,
          );
          ...
          var iconNode = this.getElementsByTagNameNS(
            styleTypeNode,
            "*",
            "Icon",
          )[0];
          ...
          var hotSpotNode = this.getElementsByTagNameNS(
            styleTypeNode,
            "*",
            "hotSpot",
          )[0];
    ...
    for (var i = 0, len = nodes.length; i < len; i++) {
      ...
      if (feature) {
        ...
        if (this.extractStyles) {
          ...
          // processed as well
          var inlineStyleNode = this.getElementsByTagNameNS(
            featureNode,
            "*",
            "Style",
          )[0];
  ...
  createPlacemarkXML: function (feature) {
    ...
    var label =
      feature.style && feature.style.label ? feature.style.label : feature.id;
      ...
      if (
        ...
        if (typeof attributes[attributeName] == "object") {
          ...
          if (attributes[attributeName].value) {
            value.appendChild(
              this.createTextNode(attributes[attributeName].value),
            );
          }
