...
(function () {
  ...
  var a = function (l, o) {
    ...
    if (o.namespaceURI && o.xml) {
      ...
      if (
        l.ownerDocument &&
        l.ownerDocument.importNode &&
        l.ownerDocument !== o.ownerDocument
      ) {
  ...
  var e = function (h) {
    ...
    if (h.node) {
      ...
      if (h.url) {
        this.load({ url: h.url, callback: h.callback, scope: h.scope });
      }
    }
  };
  g(e.prototype, {
    ...
    process: function (h) {
      var i, j;
      h = g({ context: null, clone: false, string: false }, h);
    ...
    load: function (j) {
      ...
      f.loadTemplate({ url: j.url, callback: h, failure: i, scope: this });
    },
    appendTo: function (h) {
      ...
      replace: function () {
        ...
        if (k[0] === "structure") {
          ...
          while (m.firstChild) {
            ...
            if (
              this.element.node.ownerDocument &&
