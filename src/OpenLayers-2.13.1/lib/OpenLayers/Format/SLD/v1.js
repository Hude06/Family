  ...
  readers: OpenLayers.Util.applyDefaults(
    {
      sld: {
        ...
        PerpendicularOffset: function (node, symbolizer) {
          var labelPerpendicularOffset = this.readers.ogc._expression.call(
            this,
            node,
          );
          // always string, could be empty string
      ...
      sld: {
        ...
        Stroke: function (symbolizer) {
          ...
          if (
            ...
            symbolizer.strokeDashstyle !== "solid"
          ) {
        ...
        TextSymbolizer: function (symbolizer) {
          ...
          if (
            symbolizer.labelAnchorPointX != null ||
        ...
        LinePlacement: function (symbolizer) {
          ...
          this.writeNode(
            "PerpendicularOffset",
            symbolizer.labelPerpendicularOffset,
            node,
          );
          return node;
        },
        ...
        ColorMapEntry: function (colorMapEntry) {
          ...
          a.opacity !== undefined &&
            node.setAttribute("opacity", parseFloat(a.opacity));
          a.quantity !== undefined &&
            node.setAttribute("quantity", parseFloat(a.quantity));
