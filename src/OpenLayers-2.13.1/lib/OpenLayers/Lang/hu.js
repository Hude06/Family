...
OpenLayers.Lang["hu"] = OpenLayers.Util.applyDefaults({
  ...
  methodDeprecated:
    "Ez a módszer érvénytelenítve lett és a 3.0-s verzióból el lesz távolítva. Használja a(z) ${newMethod} módszert helyette.",
});
