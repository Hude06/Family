...
(function () {
    ...
    eventListeners: {
      moveend: function () {
        ...
        window.location.hash =
          "x=" + ctr.lon + "&y=" + ctr.lat + "&z=" + map.getZoom();
  ...
  OpenLayers.Request.GET({
    ...
    success: function (request) {
      ...
      fmzk = format.createLayer(
        caps,
        OpenLayers.Util.applyDefaults({ layer: "fmzk" }, defaults),
      );
      aerial = format.createLayer(
        caps,
        OpenLayers.Util.applyDefaults({ layer: "lb" }, defaults),
      );
      labels = format.createLayer(
        caps,
