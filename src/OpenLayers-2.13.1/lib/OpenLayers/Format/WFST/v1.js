    ...
    wfs: {
          ...
          if (options.multi === true) {
            OpenLayers.Util.extend(this.geometryTypes, {
              ...
              "OpenLayers.Geometry.LineString":
                this.multiCurve === true ? "MultiCurve" : "MultiLineString",
              "OpenLayers.Geometry.Polygon":
                this.multiSurface === true ? "MultiSurface" : "MultiPolygon",
            });
          }
          var name, feature;
      ...
      Update: function (obj) {
        ...
        if (
          ...
          (!modified || modified.geometry !== undefined)
        ) {
          this.srsName = this.getSrsName(feature);
          this.writeNode(
            "Property",
            { name: this.geometryName, value: feature.geometry },
            node,
          );
        }
        ...
        for (var key in feature.attributes) {
          if (
            ...
            this.writeNode(
              "Property",
              { name: key, value: feature.attributes[key] },
              node,
            );
          }
        }
