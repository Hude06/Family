  ...
  readers: {
    wms: {
      ...
      Layer: function (node, obj) {
        ...
        var queryable =
          attrNode && attrNode.specified
            ? node.getAttribute("queryable")
            : null;
        attrNode = node.getAttributeNode("cascaded");
        var cascaded =
          attrNode && attrNode.specified ? node.getAttribute("cascaded") : null;
        attrNode = node.getAttributeNode("opaque");
        var opaque =
          attrNode && attrNode.specified ? node.getAttribute("opaque") : null;
        ...
        var layer = {
          ...
          cascaded:
            cascaded !== null ? parseInt(cascaded) : parent.cascaded || 0,
          opaque: opaque
          ...
          fixedWidth:
            fixedWidth != null ? parseInt(fixedWidth) : parent.fixedWidth || 0,
          fixedHeight:
            fixedHeight != null
              ? parseInt(fixedHeight)
              : parent.fixedHeight || 0,
