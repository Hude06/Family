...
OpenLayers.Protocol.WFS.v1 = OpenLayers.Class(OpenLayers.Protocol, {
  ...
  read: function (options) {
    ...
    var data = OpenLayers.Format.XML.prototype.write.apply(this.format, [
      this.format.writeNode("wfs:GetFeature", options),
    ]);
  ...
  filterDelete: function (filter, options) {
    ...
    var deleteNode = this.format.createElementNSPlus("wfs:Delete", {
      attributes: {
        typeName:
          (options.featureNS ? this.featurePrefix + ":" : "") +
          options.featureType,
      },
    });
