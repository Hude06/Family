  ...
  createBox: function () {
    ...
    var vertexResizeFn = function (scale, center, ratio) {
      ...
      this._rotationHandle &&
        this._rotationHandle.geometry.resize(scale, center, ratio);
      this._handle.geometry.resize(scale, center, ratio);
    };
    var vertexRotateFn = function (angle, center) {
      OpenLayers.Geometry.Point.prototype.rotate.apply(this, arguments);
      this._rotationHandle &&
        this._rotationHandle.geometry.rotate(angle, center);
    ...
    var handleMoveFn = function (x, y) {
      ...
      var preserveAspectRatio =
        !control._setfeature && control.preserveAspectRatio;
      ...
      if (control.irregular && !control._setfeature) {
        ...
        newCenter.x +=
          Math.abs(oldX - centerGeometry.x) < 0.00001 ? 0 : this.x - oldX;
        newCenter.y +=
          Math.abs(oldY - centerGeometry.y) < 0.00001 ? 0 : this.y - oldY;
    ...
    for (var i = 0; i < 8; ++i) {
      ...
      handle = new OpenLayers.Feature.Vector(
        geom.clone(),
        {
      ...
      if (i % 2 == 0) {
        rotationHandle = new OpenLayers.Feature.Vector(
          geom.clone(),
          {
