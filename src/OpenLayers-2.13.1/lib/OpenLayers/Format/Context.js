...
OpenLayers.Format.Context = OpenLayers.Class(
  OpenLayers.Format.XML.VersionedOGC,
  {
    ...
    read: function (data, options) {
      var context = OpenLayers.Format.XML.VersionedOGC.prototype.read.apply(
        this,
        arguments,
      );
      var map;
      if (options && options.map) {
        ...
        if (options.map instanceof OpenLayers.Map) {
          ...
          if (
            OpenLayers.Util.isElement(mapOptions) ||
    ...
    write: function (obj, options) {
      ...
      return OpenLayers.Format.XML.VersionedOGC.prototype.write.apply(
        this,
        arguments,
      );
    },
