...
var map = new OpenLayers.Map({
  ...
  restrictedExtent: new OpenLayers.Bounds(1035374, 7448940, 1074510, 7468508),
...
var draw = new OpenLayers.Control.DrawFeature(lines, OpenLayers.Handler.Path, {
  displayClass: "olControlDrawFeaturePath",
  title: "Draw Features",
});
modify = new OpenLayers.Control.ModifyFeature(lines, {
