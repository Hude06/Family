...
OpenLayers.Strategy.RuleCluster = OpenLayers.Class(
  OpenLayers.Strategy.Cluster,
  {
    ...
    shouldCluster: function (cluster, feature) {
      var superProto = OpenLayers.Strategy.Cluster.prototype;
      return (
        this.rule.evaluate(cluster.cluster[0]) &&
...
(function () {
  ...
  var showInformation = function (evt) {
    ...
    if (feature.cluster) {
      info +=
        "&nbsp;&nbsp;Cluster of " + feature.attributes.count + " features:";
      var clazzes = {
        1: 0,
        2: 0,
        3: 0,
      ...
      info +=
        "&nbsp;&nbsp;Single feature of clazz = " + feature.attributes.clazz;
    }
  ...
  // the select control
  select = new OpenLayers.Control.SelectFeature(vectorlayer, { hover: true });
