...
document.getElementById("insertXY").onclick = function () {
  var values = parseInput(
    window.prompt(
      "Enter map coordinates for new point (e.g. '-111, 46')",
      "x, y",
    ),
  );
  if (values != null) {
...
document.getElementById("insertDeltaXY").onclick = function () {
  var values = parseInput(
    window.prompt(
      "Enter offset values for new point (e.g. '15, -10')",
      "dx, dy",
    ),
  );
  if (values != null) {
...
document.getElementById("insertDirectionLength").onclick = function () {
  var values = parseInput(
    window.prompt(
      "Enter direction and length offset values for new point (e.g. '-45, 10')",
      "direction, length",
    ),
  );
  if (values != null) {
...
document.getElementById("insertDeflectionLength").onclick = function () {
  var values = parseInput(
    window.prompt(
      "Enter deflection and length offset values for new point (e.g. '15, 20')",
      "deflection, length",
    ),
  );
  if (values != null) {
