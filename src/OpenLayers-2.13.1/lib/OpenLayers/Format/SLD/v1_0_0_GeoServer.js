        ...
        sld: OpenLayers.Util.applyDefaults(
          {
            ...
            TextSymbolizer: function (node, rule) {
              ...
              var symbolizer = this.multipleSymbolizers
                ? rule.symbolizers[rule.symbolizers.length - 1]
        ...
        sld: OpenLayers.Util.applyDefaults(
          {
            ...
            TextSymbolizer: function (symbolizer) {
              ...
              var node = writers["sld"]["TextSymbolizer"].apply(
                this,
                arguments,
              );
              if (
                symbolizer.graphic !== false &&
                (symbolizer.externalGraphic || symbolizer.graphicName)
              ) {
            ...
            PointSymbolizer: function (symbolizer) {
              var writers = OpenLayers.Format.SLD.v1_0_0.prototype.writers;
              var node = writers["sld"]["PointSymbolizer"].apply(
                this,
                arguments,
              );
              return this.addVendorOptions(node, symbolizer);
            ...
            LineSymbolizer: function (symbolizer) {
              var writers = OpenLayers.Format.SLD.v1_0_0.prototype.writers;
              var node = writers["sld"]["LineSymbolizer"].apply(
                this,
                arguments,
              );
              return this.addVendorOptions(node, symbolizer);
            ...
            PolygonSymbolizer: function (symbolizer) {
              var writers = OpenLayers.Format.SLD.v1_0_0.prototype.writers;
              var node = writers["sld"]["PolygonSymbolizer"].apply(
                this,
                arguments,
              );
              return this.addVendorOptions(node, symbolizer);
