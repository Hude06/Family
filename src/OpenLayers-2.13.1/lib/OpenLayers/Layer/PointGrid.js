...
OpenLayers.Layer.PointGrid = OpenLayers.Class(OpenLayers.Layer.Vector, {
  ...
  getViewBounds: function () {
    ...
    if (this.rotation) {
      ...
      var rotationOrigin = new OpenLayers.Geometry.Point(
        origin.lon,
        origin.lat,
      );
  ...
  updateGrid: function (force) {
    if (force || this.invalidBounds()) {
      ...
      var maxHeight = Math.sqrt(
        (this.dx * this.dy * this.maxFeatures) / aspectRatio,
      );
      ...
      var gridLeft =
        origin.lon +
        this.dx * Math.ceil((this.gridBounds.left - origin.lon) / this.dx);
      var gridBottom =
        origin.lat +
        this.dy * Math.ceil((this.gridBounds.bottom - origin.lat) / this.dy);
  ...
  invalidBounds: function () {
    return (
      !this.gridBounds || !this.gridBounds.containsBounds(this.getViewBounds())
    );
  },
