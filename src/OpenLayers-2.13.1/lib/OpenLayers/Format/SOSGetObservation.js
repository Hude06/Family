  ...
  readers: {
    om: {
      ...
      observedProperty: function (node, measurement) {
        measurement.observedProperty = this.getAttributeNS(
          node,
      ...
      procedure: function (node, measurement) {
        measurement.procedure = this.getAttributeNS(
          node,
          this.namespaces.xlink,
          "href",
        );
    ...
    sos: {
      GetObservation: function (options) {
        ...
        for (var observedProperty in options.observedProperties) {
          this.writeNode(
            "observedProperty",
            options.observedProperties[observedProperty],
            node,
          );
        }
        if (options.foi) {
      ...
      ObjectID: function (options) {
        return this.createElementNSPlus("ObjectID", { value: options });
      },
      ...
      procedure: function (procedure) {
        return this.createElementNSPlus("procedure", { value: procedure });
      },
