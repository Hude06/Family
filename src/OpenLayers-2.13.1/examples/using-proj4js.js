...
function init() {
  map = new OpenLayers.Map("map", {
    ...
    controls: [
      ...
      new OpenLayers.Control.MousePosition({
        ...
        prefix: "Coordinates: ",
        suffix:
          ' (in <a href="http://spatialreference.org/ref/epsg/' +
          '31467/">EPSG:31467</a>)',
      }),
      new OpenLayers.Control.MousePosition({
  ...
  var germany_gk3 = new OpenLayers.Layer.WMS(
    ...
    },
    {
      ...
      ratio: 1.0,
      attribution:
        "Background WMS offered without restrictions by " +
...
function addVector(x, y, btn) {
  ...
  status += '<br /><code class="emph">  ' + geometry.toString() + "</code> to";
  ...
  status += '<br /><code class="emph">  ' + geometry.toString() + "</code>.";
