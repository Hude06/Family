...
OpenLayers.Renderer.Canvas = OpenLayers.Class(OpenLayers.Renderer, {
  ...
  drawExternalGraphic: function (geometry, style, featureId) {
    ...
    var xOffset =
      style.graphicXOffset != undefined ? style.graphicXOffset : -(0.5 * width);
    var yOffset =
  ...
  drawNamedSymbol: function (geometry, style, featureId) {
    ...
    scaling =
      (2.0 * style.pointRadius) /
      Math.max(symbolBounds.getWidth(), symbolBounds.getHeight());
    ...
    if (type == "fill") {
      ...
      if (typeof strokeScaling === "undefined") {
        ...
        if (!isNaN(strokeScaling)) {
          this.hitContext.lineWidth =
            symbolizer.strokeWidth + 2.0 / strokeScaling;
        }
      }
    } else {
  ...
  drawText: function (location, style) {
    ...
    if (this.canvas.fillText) {
      ...
      this.canvas.textAlign =
        OpenLayers.Renderer.Canvas.LABEL_ALIGN[style.labelAlign[0]] || "center";
      this.canvas.textBaseline =
        OpenLayers.Renderer.Canvas.LABEL_ALIGN[style.labelAlign[1]] || "middle";
      var vfactor =
      ...
      for (var i = 0; i < numRows; i++) {
        if (style.labelOutlineWidth) {
          ...
          this.canvas.globalAlpha =
            style.labelOutlineOpacity || style.fontOpacity || 1.0;
    ...
    if (this.hitDetection && this.root.style.display !== "none") {
      ...
      if (!this.map.dragging) {
        ...
        if (data[3] === 255) {
          ...
          if (id) {
            featureId =
              "OpenLayers_Feature_Vector_" + (id - 1 + this.hitOverflow);
            try {
