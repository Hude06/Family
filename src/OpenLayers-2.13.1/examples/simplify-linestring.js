...
(function () {
  ...
  var original = OpenLayers.Geometry.fromWKT(
    "LINESTRING(" +
      "6.247872 11.316756," +
      "6.338566 11.316756," +
      "6.633323 11.205644," +
  ...
  var simplify = function () {
    ...
    infotxt +=
      " <li>Simplified geometry: <strong>" +
      simplifiedVerticesCnt +
      " vertices</strong></li>";
    infotxt +=
      " <li>Decreased by <strong>" +
      (
        ((originalVerticesCnt - simplifiedVerticesCnt) / originalVerticesCnt) *
        100
      ).toFixed(2) +
