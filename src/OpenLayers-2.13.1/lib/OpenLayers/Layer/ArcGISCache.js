...
OpenLayers.Layer.ArcGISCache = OpenLayers.Class(OpenLayers.Layer.XYZ, {
  ...
  calculateMaxExtentWithLOD: function (lod) {
    ...
    var minX =
      this.tileOrigin.lon + lod.startTileCol * this.tileSize.w * lod.resolution;
    var maxX = minX + numTileCols * this.tileSize.w * lod.resolution;

    var maxY =
      this.tileOrigin.lat - lod.startTileRow * this.tileSize.h * lod.resolution;
  ...
  getURL: function (bounds) {
    ...
    var x = Math.round(
      Math.abs((center.lon - originTileX) / (res * this.tileSize.w)),
    );
    var y = Math.round(
      Math.abs((originTileY - center.lat) / (res * this.tileSize.h)),
    );
    ...
    return OpenLayers.Util.urlAppend(
      url,
      OpenLayers.Util.getParameterString(this.params),
    );
  },
