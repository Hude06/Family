...
OpenLayers.Lang["nl"] = OpenLayers.Util.applyDefaults({
  ...
  methodDeprecated:
    "Deze methode is verouderd en wordt verwijderd in versie 3.0.\nGebruik ${newMethod}.",
});
