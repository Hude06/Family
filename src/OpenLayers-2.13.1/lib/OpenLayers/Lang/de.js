...
OpenLayers.Lang["de"] = OpenLayers.Util.applyDefaults({
  ...
  noFID:
    "Ein Feature, für das keine FID existiert, kann nicht aktualisiert werden.",
  ...
  methodDeprecated:
    "Die Methode ist veraltet und wird in 3.0 entfernt. Bitte verwende stattdessen ${newMethod}.",
});
