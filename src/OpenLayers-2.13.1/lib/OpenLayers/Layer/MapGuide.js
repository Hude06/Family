...
OpenLayers.Layer.MapGuide = OpenLayers.Class(OpenLayers.Layer.Grid, {
  ...
  getImageFilePath: function (newParams, altUrl) {
    ...
    if (newParams.tilerow == 0) {
      ...
      tileRowGroup +=
        Math.floor(
          Math.abs(newParams.tilerow / this.params.tileRowsPerFolder),
    ...
    if (newParams.tilecol == 0) {
      ...
      tileColGroup +=
        Math.floor(
          Math.abs(newParams.tilecol / this.params.tileColumnsPerFolder),
        ) * this.params.tileColumnsPerFolder;
    }

    var tilePath =
      "/S" +
      Math.floor(newParams.scaleindex) +
      "/" +
      ...
      "_" +
      (newParams.tilecol % this.params.tileColumnsPerFolder) +
      "." +
      this.params.format;
